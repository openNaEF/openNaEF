...
public class PortSelectionPanel extends Panel {
    private static final long serialVersionUID = 1L;
    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(PortSelectionPanel.class);
    ...
    public PortSelectionPanel(final String id, final WebPage parent, final String nodeName,
