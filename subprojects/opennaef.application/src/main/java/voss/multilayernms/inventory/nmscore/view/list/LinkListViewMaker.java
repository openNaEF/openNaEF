...
public class LinkListViewMaker extends ListViewMaker {

    @SuppressWarnings("unused")
    private final Logger log = LoggerFactory.getLogger(LinkListViewMaker.class);

    public LinkListViewMaker(ObjectFilterQuery query) throws IOException {
