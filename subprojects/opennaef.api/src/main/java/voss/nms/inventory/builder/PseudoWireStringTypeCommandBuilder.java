...
public class PseudoWireStringTypeCommandBuilder extends AbstractCommandBuilder {
    ...
    public PseudoWireStringTypeCommandBuilder(String poolName, String editorName) {
        super(PseudowireDto.class, null, editorName);
        setConstraint(PseudowireDto.class);
        this.pw = null;
        try {
            this.pool = PseudoWireUtil.getStringPool(poolName);
        } catch (Exception e) {
            throw ExceptionUtils.throwAsRuntime(e);
        }
    }

    public PseudoWireStringTypeCommandBuilder(PseudowireStringIdPoolDto pool, String editorName) {
        super(PseudowireDto.class, null, editorName);
        setConstraint(PseudowireDto.class);
        this.pw = null;
        try {
    ...
    public PseudoWireStringTypeCommandBuilder(PseudowireDto target, String editorName) {
    ...
    public void setPool(PseudowireStringIdPoolDto pool) {
        this.pool = pool;
    }
    ...
    public void setAttachmentCircuit1(PortDto ac) {
        ...
        if (this.pw != null) {
            ...
            prevAc = DtoUtil.getAbsoluteName(pw.getAc1());
        }
    ...
    public void setAttachmentCircuit2(PortDto ac) {
        ...
        if (this.pw != null) {
            ...
            prevAc = DtoUtil.getAbsoluteName(pw.getAc2());
        }
    ...
    protected BuildResult buildDeleteCommandInner() throws IOException {
        ...
        cmd.addLastEditCommands();
        InventoryBuilder.buildNetworkIDReleaseCommand(cmd, ATTR.ATTR_PW_ID_STRING, ATTR.ATTR_PW_POOL_STRING);
        recordChange("PseudoWire", pw.getStringId(), null);
        return BuildResult.SUCCESS;
    }
