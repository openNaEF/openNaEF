...
public class POSAPSCommandBuilder extends PortCommandBuilder {
    private static final long serialVersionUID = 1L;
    private final NodeDto owner;
    private final String nodeName;
    private final String apsName;
    private final PosApsIfDto aps;
    private final Set<String> addedPorts = new HashSet<String>();
    private final Set<String> removedPorts = new HashSet<String>();

    public POSAPSCommandBuilder(String nodeName, String apsName, String editorName) {
        super(PosApsIfDto.class, null, null, editorName);
        setConstraint(PosApsIfDto.class);
        this.owner = null;
        this.aps = null;
    ...
    public POSAPSCommandBuilder(PosApsIfDto aps, String editorName) {
        super(PosApsIfDto.class, aps.getNode(), aps, editorName);
    ...
    public void setMemberPorts(Map<String, String> memberIfNamesAndAbsoluteNames) {
        if (aps != null) {
            ...
            for (PosPortDto member : aps.getPosPorts()) {
    ...
    public BuildResult buildPortCommands() throws InventoryException {
        ...
        if (aps == null) {
            ...
            currentApsAbsName = this.nodeName + ATTR.NAME_DELIMITER_PRIMARY + ATTR.TYPE_POS_APS_PORT
            ...
            SimpleNodeBuilder.buildPortCreationCommands(cmd, ATTR.TYPE_POS_APS_PORT, currentApsName);
            setValue(MPLSNMS_ATTR.PORT_TYPE, PortType.POS_APS.getCaption());
    ...
    protected void buildPortDeleteCommand() {
        InventoryBuilder.changeContext(cmd, aps);
        for (PosPortDto eth : aps.getPosPorts()) {
