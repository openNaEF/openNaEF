...
public class TextBasedPseudoWireCommandBuilder extends AbstractCommandBuilder {
    ...
    public TextBasedPseudoWireCommandBuilder(PseudowireLongIdPoolDto pool, String editorName) {
    ...
    public TextBasedPseudoWireCommandBuilder(PseudowireDto target, String editorName) {
    ...
    public void setAttachmentCircuit1Name(String acName, String ifName) {
        ...
        recordChange(ATTR.PW_AC1, oldAcName, acName, false);
        this.ac1Name = acName;
    }
    ...
    public void setAttachmentCircuit2Name(String acName, String ifName) {
        ...
        recordChange(ATTR.PW_AC2, oldAcName, acName, false);
        this.ac2Name = acName;
    }
    ...
    protected BuildResult buildDeleteCommandInner() throws IOException {
        if (this.pw == null) {
            return setResult(BuildResult.FAIL);
        }
        InventoryBuilder.changeContext(cmd, this.pw);
        if (pw.getAc1() != null) {
