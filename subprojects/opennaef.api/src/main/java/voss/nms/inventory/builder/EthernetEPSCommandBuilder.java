...
public class EthernetEPSCommandBuilder extends PortCommandBuilder {
    ...
    public EthernetEPSCommandBuilder(String nodeName, String lagName, String editorName) {
    ...
    public EthernetEPSCommandBuilder(EthLagIfDto lag, String editorName) {
    ...
    public BuildResult buildPortCommands() throws InventoryException {
        ...
        setValue(MPLSNMS_ATTR.PORT_TYPE, PortType.EPS.getCaption());
        setValue(MPLSNMS_ATTR.EPS_FLAG, Boolean.TRUE.toString());
