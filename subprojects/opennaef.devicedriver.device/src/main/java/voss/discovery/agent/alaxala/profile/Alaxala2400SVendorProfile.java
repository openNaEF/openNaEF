...
public class Alaxala2400SVendorProfile extends AlaxalaK0SeriesVendorProfile {

    private final static String ax2430s_prefix = Mib2.Snmpv2_SMI_enterprises
            + ".21839.2.2.6";
    private final static String axPhysLineConnectorType = ax2430s_prefix
            + ".2.2.1.1.2";

    private final static String AX2430S_OS_VERSION = ax2430s_prefix + ".1.2.3";

    public String getOsVersionOid() {
        return AX2430S_OS_VERSION;
    }

    private final static String AX2430S_NUMBER_OF_PORTS = ax2430s_prefix
            + ".2.1.2.1.19";
    ...
    private final static String ax2430sPhysLineTransceiverStatus = ax2430s_prefix
            + ".2.2.1.1.5";
