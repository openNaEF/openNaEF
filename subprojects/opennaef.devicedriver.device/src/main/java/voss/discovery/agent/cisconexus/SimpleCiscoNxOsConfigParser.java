...
public class SimpleCiscoNxOsConfigParser extends AbstractSimpleConfigurationParser {
    private final static Logger log = LoggerFactory
            .getLogger(SimpleCiscoNxOsConfigParser.class);

    public SimpleCiscoNxOsConfigParser(String config) {
        super(config);
    }
