...
public class VMEthernetPortRenderer extends AbstractHardPortRenderer<EthernetPort> {
    protected static final Logger log = LoggerFactory.getLogger(LogConstants.DIFF_SERVICE);

    public VMEthernetPortRenderer(EthernetPort port, String parentID, int depth, Map<String, String> map) {
        ...
        switch (attr) {
            ...
            case DUPLEX_ADMIN:
                ...
                if (duplex != null) {
                    ...
                    } else if (duplex.getValue().equals(Duplex.FULL)) {
                        return PortConstants.DUPLEX_FULL;
                    } else if (duplex.getValue().equals(Duplex.HALF)) {
                        return PortConstants.DUPLEX_HALF;
                    }
                    throw new IllegalStateException("illegal value: " + duplex.getValue());
                }
                return null;
            case PORTSPEED_OPER:
