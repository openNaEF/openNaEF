...
public class AtmPortRenderer extends AbstractHardPortRenderer<AtmPortImpl> {
    protected static final Logger log = LoggerFactory.getLogger(LogConstants.DIFF_SERVICE);

    public AtmPortRenderer(AtmPortImpl port, String parentID, int depth, Map<String, String> map) {
    ...
    protected String buildAbsoluteName(String parentAbsoluteName) {
        return AbsoluteNameFactory.getAtmPortAbsoluteName(getParentAbsoluteName(), getModel());
    }
