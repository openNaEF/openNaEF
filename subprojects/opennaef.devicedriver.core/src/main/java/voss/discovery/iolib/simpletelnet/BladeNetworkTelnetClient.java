...
public class BladeNetworkTelnetClient extends RealTelnetClient {
    private static final Logger log = LoggerFactory.getLogger(BladeNetworkTelnetClient.class);
    ...
    public BladeNetworkTelnetClient(TerminalSocket socket, NodeInfo telnet) {
        super(telnet);
    ...
    public String changeMode(String changingMode) throws IOException, ConsoleException {
        ...
        if (MODE_LOGIN.equals(currentMode) && MODE_ENABLE.equals(changingMode)) {
            ...
            throw new UnsupportedOperationException("Current:" + currentMode + " To:" + changingMode);
        }
    }
    ...
    private String changeLoginToEnableMode() throws IOException,
            ConsoleException {
        sendln("enable");
        ReceiveResult result = receiveTo(new String[]{"password: ", ENABLE_PROMPT});
        if ("password: ".equals(result.getReceiveKey())) {
